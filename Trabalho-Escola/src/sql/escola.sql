...
IF(@CPF_ALUNO > 0)
	...
	RAISERROR('O CPF do aluno já existe no BD', 15,1)
	RETURN
	END
...
--testando 
EXEC SP_I_ESC_ALUNO 'Jonatan Vieira', '124.412.642-51'
...
EXEC SP_I_ESC_PROFESSOR '', '122.512.423-51', 'Banco de Dados';
...
EXEC SP_U_ESC_ALUNO 1, 'Heitor Lorenzo', '512.325.521-27'
SELECT * FROM ESC_ALUNO

--PROCEDURE UPDATE PROFESSOR
USE ESCOLA;
GO
CREATE PROCEDURE SP_U_ESC_PROFESSOR
...
EXEC SP_U_ESC_PROFESSOR 2, 'Wallace Leandro', '122.512.423-51', 'Contabilidade'
SELECT * FROM ESC_PROFESSOR
...
--teste
EXEC SP_S_ESC_ALUNO 'Ricardo Leme';
...
--testando
EXEC SP_S_ESC_PROFESSOR 'Willian Shakespeare';